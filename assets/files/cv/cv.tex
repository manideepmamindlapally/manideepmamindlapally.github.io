...
\begin{tabular}{p{2.5cm} p{2.3cm} p{8.2cm} p{2.4cm} }
	...
	\footnotesize{MINOR: Computer Science Engineering} & \href{https://drive.google.com/open?id=1E7yk9KwE8mNCMqM2oD5x_FURKZQNatyh}{9.16}/10\footnotesize{ (CGPA) } \hbox{} \normalsize{9.09/10}\footnotesize{ (ACGPA) }\\
	\textsc{April} 2017 & TSBIE & \textsc{FIITJEE Junior College, Hyderabad} & \href{https://drive.google.com/open?id=0B7pFhjg7rbirUDhqeERYWW5qNzdnQmhvUzhpdTQwZkFPcmhz}{97.0}\%\\  
	\textsc{April} 2015 & ICSE & \textsc{Johnson Grammar School(ICSE), Hyderabad} &  \href{https://drive.google.com/open?id=0B7pFhjg7rbirNjczX3RMdEVmNEZyU0dmazY0WnRUMWYyUHlR}{95.7}\%
\end{tabular}
\end{center}
